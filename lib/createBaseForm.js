  ...
  function decorate(WrappedComponent) {
    var Form = _react2["default"].createClass({
      ...
      clearUp: function clearUp() {
        ...
        var fieldsMeta = this.fieldsMeta;
        var delNames = fieldsMeta ? Object.keys(fieldsMeta).filter(function (name) {
          return fieldsMeta[name].deleted && fieldsMeta[name].deleted === true;
        }) : [];

        delNames.forEach(function (name) {
          delete _this5.fieldsMeta[name];
          delete _this5.fields[name];
          delete _this5.instances[name];
          delete _this5.cachedBind[name];
        });
      },
      validateFieldsInternal: function validateFieldsInternal(fields, _ref2, callback) {
        ...
        Object.keys(allValues).forEach(function (f) {
          allValues[f] = _this6.getFieldValue(f);
        });
        ...
        validator.validate(allValues, options, function (errors) {
          ...
          Object.keys(allRules).forEach(function (name) {
            ...
            var nowField = _this6.getField(name);
          ...
          if (callback) {
            ...
            callback((0, _utils.isEmptyObject)(showErrorsGroup) ? null : showErrorsGroup, _this6.getFieldsValue((0, _utils.flatFieldNames)(fieldNames)));
          }
        });
      },
      validateFields: function validateFields(ns, opt, cb) {
        ...
        var fields = fieldNames.map(function (name) {
          ...
          var field = _this7.getField(name);
          field.value = _this7.getFieldValue(name);
          return field;
        }).filter(function (f) {
          return !!f;
        });
      ...
      isFieldsValidating: function isFieldsValidating(ns) {
        ...
        return names.some(function (n) {
          return _this8.isFieldValidating(n);
        });
      },
      ...
      render: function render() {
        ...
        var result = _react2["default"].createElement(WrappedComponent, props);
        return result;
      }
    });
